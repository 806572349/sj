 ...
 * @since 2018-06-08
 */
@TableName("mac_vod_type")
class MacVodType : Model<MacVodType>() {
    ...
    @TableField("t_tpl_vod")
    var tTplVod: String? = null
    @TableField("t_tpl_play")
    var tTplPlay: String? = null
    @TableField("t_tpl_down")
    var tTplDown: String? = null
    @TableField("t_key")
